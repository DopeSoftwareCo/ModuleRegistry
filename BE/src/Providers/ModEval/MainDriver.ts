...
export async function ModEval(code: number) {
    ...
    if(code == 1)
    {
        spec = [Dummy.wspec_A0, Dummy.wspec_A1, Dummy.wspec_A2, Dummy.wspec_A3, Dummy.wspec_A4, Dummy.wspec_A5, Dummy.wspec_A6];
        urls = [ Dummy.url_A0, Dummy.url_A1, Dummy.url_A2, Dummy.url_A3];
    }
    else if(code == 2)
    {
        spec = [Dummy.wspec_B0, Dummy.wspec_B1, Dummy.wspec_B2, Dummy.wspec_B3, Dummy.wspec_B4, Dummy.wspec_B5, Dummy.wspec_B6];
        urls = [Dummy.url_B0, Dummy.url_B1, Dummy.url_B2, Dummy.url_B3, Dummy.url_B4];

    }
    else (code == 3)
    {
        spec = [Dummy.wspec_C0, Dummy.wspec_C1, Dummy.wspec_C2, Dummy.wspec_B3, Dummy.wspec_C4, Dummy.wspec_C5, Dummy.wspec_C6];
