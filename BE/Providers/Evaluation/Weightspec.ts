...
export class Weightspec {
    ...
    private Validate_Spec(): boolean
    {
        ...
        let scaledWeights = [this.rampup_weight * scale, this.busfactor_weight * scale, this.correctness_weight * scale, this.response_weight * scale]

        this.total = 0;
        let index, greatest, indexof_greatest = 0;
